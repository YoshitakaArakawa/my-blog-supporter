...
- [Business intelligence: A complete overview](https://www.tableau.com/business-intelligence/what-is-business-intelligence)
...
- [The scarce resource is consensus](https://roundup.getdbt.com/p/the-scarce-resource-is-consensus)

この記事では、AIとBIを対立ではなく協業として捉えたときに、BIプラットフォームから何を外し、何を求めるべきかについて考えたことを書きます。ちなみにタイトルの「AI🤝BI」は、AIとBIが握手してます。コラボレーションですね。
...
組織が合意して使っているダッシュボードを、そのままAIと共有する。人とAIが同じダッシュボードを見て、状態の認識を揃え、アドホックな分析はそこを起点に進めていく。人間が問いを立て、AIがデータを掘り、一緒に示唆を得ていく形です。
...
AIは使う人の力を増幅するとして、データもAIも使えるのが専任者だけという世界は、組織の中の格差になり面白いコラボレーションを阻害するかもしれませんよね。データもAIを使える人を専任者の外まで広げる世界観を、BI製品に自分は求めたいのかもしれません。機能ではなくプラットフォーム性やデータ文化を求めたいのかなと。
...
アドホックな分析はAIに渡し、人とAIが同じ状態を見て合意する面はBIに残す。そして、その面を使う作法とコミュニティを育てる世界観まで含めて、BIを見たい。この辺りが自分の今の見立てです。これが今の自分の「AI🤝BI」観です。
...
人間を前提にインターフェースや権限設定、ガバナンスを作ってきましたよね。今は、その資産をAIが使う場面が増えています。なので、人間とAIで、見られる範囲とできる操作を分けられるBIプラットフォームがあったら、すごく素晴らしそうだなと。
...
（そういう話がTableau ”Next"として出てきたら爆上げしそう...BIプラットフォームとして圧倒的に次世代感ありそうじゃないですか？）
